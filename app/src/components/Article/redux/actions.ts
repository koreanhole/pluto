...
export const FETCH_INITIAL_NOTICE_LIST_REQUEST = "FETCH_INITIAL_NOTICE_LIST_REQUEST";
export const FETCH_INITIAL_NOTICE_LIST_SUCCESS = "FETCH_INITIAL_NOTICE_LIST_SUCCESS";
export const FETCH_INITIAL_NOITICE_LIST_FAILURE = "FETCH_INITIAL_NOITICE_LIST_FAILURE";
...
export const deleteSavedNotice = createAction("DELETE_SAVED_NOTICE")<NoticeArticle>();

export const sortSavedNotice = createAction("SORT_SAVED_NOTICE")<SavedArticleSorting>();
...
)<FetchInitialNoticeListRequestPayload, FetchInitialNoticeListSuccessPayload | null, string>();
